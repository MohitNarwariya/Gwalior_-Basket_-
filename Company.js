...
export default function Company(props) {
 ...
 const fillCities=()=>{
  ...
  setCity('Choose City...')
  setCompanyLogo({fileName: "/assets/watermark.png",
  bytes: "",})
    ...
    <div className={classes.mainContainer}>
      <div className={classes.box}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField  error={!error.mobileNumber?false:true} helperText={error.mobileNumber} value={mobileNumber} fullWidth onChange={(event)=>setMobileNumber(event.target.value)} label="Mobile Number" variant="outlined" onFocus={()=>handleError("mobileNumber",null)} />
          </Grid>
